# PyMOL script for 1SA0 N-terminus analysis
# Load structure (download first: wget https://files.rcsb.org/download/1SA0.cif)
load 1SA0.cif
hide everything
show cartoon
color grey, all
...
select nterm_A, chain A and resi 2
color green, nterm_A
show spheres, nterm_A
select nterm_B, chain B and resi 2
color green, nterm_B
